...
extern const u8 gText_Pie_WhichEV[];
extern const u8 gText_Pie_NormalEV[];
extern const u8 gText_Pie_TrainerEV[];
extern const u8 gText_Pie_NoEV[];
extern const u8 gText_Pie_LevelCaps[];
extern const u8 gText_Pie_NoCaps[];
extern const u8 gText_Pie_Caps[];
...
extern const u8 gText_BirchNormalEV[];
extern const u8 gText_BirchTrainerEV[];
extern const u8 gText_BirchNoEV[];
extern const u8 gText_BirchNoCaps[];
extern const u8 gText_BirchCaps[];
...
extern const u8 gText_PowPrio[];
extern const u8 gText_AccChance[];
extern const u8 gText_Note[];
extern const u8 gText_Depends[];
extern const u8 gText_User[];
extern const u8 gText_Both[];
extern const u8 gText_Ally[];
extern const u8 gText_All[];
extern const u8 gText_Random[];
extern const u8 gText_Select2[];
extern const u8 gText_Others3[];
