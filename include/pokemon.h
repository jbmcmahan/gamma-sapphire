...
enum {
    ...
    MON_DATA_TERA_TYPE,
    MON_DATA_IS_SHINY,
    MON_DATA_LEARNED_MOVES_1,
    MON_DATA_LEARNED_MOVES_2,
    MON_DATA_LEARNED_MOVES_3,
};
...
void CreateMonWithNatureIVs(struct Pokemon *mon, u16 species, u8 level, u8 *ivs, u8 nature);
