...
struct SpecialStatus
{
    ...
    bool8 switchInAbilityOrInnateDone[NUM_INNATE_PER_SPECIES + 1];
...
struct BattleStruct
{
    ...
    s8 aiFinalScore[MAX_BATTLERS_COUNT][MAX_BATTLERS_COUNT][MAX_MON_MOVES * 2]; // AI, target, moves to make debugging easier
