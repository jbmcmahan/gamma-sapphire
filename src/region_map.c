...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_ROUTE_105},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_ROUTE_105},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SERENE_PATH] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_TRANQUIL_TRAIL] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_VERDANT_WAY] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_NONE},
