...
static const u8 sLoudBangDescription[] =  _("Sound moves have 20% chance\nto confuse the foe.");
...
static const u8 sGripPincerDescription[] =  _("30% chance to trap. Then ignores\nDefense & accuracy checks.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_VENGEANCE] = _("Vengeance"),
    [ABILITY_BLITZ_BOXER] = _("Blitz Boxer"),
    [ABILITY_ANTARCTIC_BIRD] = _("AntarcticBrd"),
    [ABILITY_BURNATE] = _("Burnate"),
    [ABILITY_CRYSTALLIZE] = _("Crystallize"),
    [ABILITY_ELECTROCYTES] = _("Electrocytes"),
    [ABILITY_AERODYNAMICS] = _("Aerodynamics"),
